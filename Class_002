...
Constraints are rules applied on table columns to maintain the validity, integrity, and accuracy of the data stored in the database.

These rules ensure that the data entered by users follows certain conditions.

## Why Do We Use Constraints?

1. To prevent invalid or duplicate data.
2. To maintain relationships between tables.
3. To make sure required fields are not left empty.
4. To automatically assign default values when no value is given.
...
Unlike Primary Key, UNIQUE allows one NULL value.
...
INSERT INTO Employees VALUES (1, 'ali@gmail.com', 'Ali');
INSERT INTO Employees VALUES (2, 'sara@gmail.com', 'Sara');

-- Try inserting duplicate email
INSERT INTO Employees VALUES (3, 'ali@gmail.com', 'Bilal');  -- Will fail
```
...
That means the column must always have a value.
...
-- Try inserting NULL
INSERT INTO Departments VALUES (1, NULL);   -- Will fail

INSERT INTO Departments VALUES (1, 'Finance');  -- Works fine
```
...
CHECK ensures that values entered meet a specific condition.

## DEFAULT Constraint

DEFAULT sets a predefined value for a column when no value is given.
...
INSERT INTO Products VALUES (1, 'Keyboard', 1500);
INSERT INTO Products VALUES (2, 'Mouse', -500);  -- Will fail because Price must be > 0
```
